                                        ...
                                        <div class="modal-body">
                                            <form class="post-text ms-3 w-100" action="{{route('posts.store')}}" method="POST">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="text" class="form-control rounded"
                                                        placeholder="Write something here..." style="border:none;" name="description">
                                                </div>
                                                <hr>
                    ...
                    <div class="col-sm-12">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex  justify-content-between">
                                                <div class="">
                                                    ...
                                                    <span class="mb-0 d-inline-block">Added New Image in a
                                                        Post</span>
                                                    <p class="mb-0 text-primary">1 hour ago</p>
                                                </div>
                                                <div class="card-post-toolbar">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle" id="postdata-5"
                                ...
                                <div class="user-post">
                                    <a href="javascript:void();"><img src="../assets/images/page-img/p4.jpg"
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="user-post-data">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid" src="../assets/images/user/04.jpg"
                                                alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class=" d-flex  justify-content-between">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                                    ...
                                                    <h5 class="mb-0 d-inline-block">Bni
                                                        Cyst{{ Auth::user()->name }}</h5>
                                                    <p class="ms-1 mb-0 d-inline-block">Changed Profile Picture
                                                    </p>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="user-post-data">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid" src="../assets/images/user/02.jpg"
                                                alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                                    ...
                                                    <p class="mb-0 d-inline-block">Added New Video in his Timeline
                                                    </p>
                                ...
                                <div class="user-post">
                                    <div class="ratio ratio-16x9">
                                        <iframe src="https://www.youtube.com/embed/j_GsIanLxZk?rel=0"
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu py-2">
                                                            <a class="ms-2 me-2" href="#"
                                                                ...
                                                                title="Like"><img src="../assets/images/icon/01.png"
