                                            ...
                                            <div class="card-body">
                                                <ul class="profile-img-gallary p-0 m-0 list-unstyled">
                                                    ...
                                                    <li class=""><a href="#"><img
                                                                ...
                                                                class="img-fluid" /></a></li>
                                                    <li class=""><a href="#"><img
                                                                src="../assets/images/page-img/g7.jpg" alt="gallary-image"
                                                                class="img-fluid" /></a></li>
                                                    <li class=""><a href="#"><img
                                                                src="../assets/images/page-img/g8.jpg" alt="gallary-image"
                                                                class="img-fluid" /></a></li>
                                                    <li class=""><a href="#"><img
                                                                src="../assets/images/page-img/g9.jpg" alt="gallary-image"
                                                                class="img-fluid" /></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal-dialog  modal-lg modal-fullscreen-sm-down">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="post-text ms-3 w-100" action="{{route('posts.store')}}" method="POST">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <input type="text" class="form-control rounded"
                                                                        ...
                                                                        style="border:none;" name="description">
                                                                </div>
                                                        ...
                                                        <input type="submit"
                                                            class="btn btn-primary d-block w-100 mt-3" value = "submit">
                                                    </form>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                @foreach ($posts as $post)
                                                    <div class="post-item">
                                                                                ...
                                                                                <div class="dropdown-menu m-0 p-0">
                                                                                    ...
                                                                                    <a class="dropdown-item p-3">
                                                                                        <div class="d-flex align-items-top">
                                                                                            ...
                                                                                            <div class="data ms-2" data-bs-toggle="modal" data-bs-target="#editPostModal{{ $post->id }}">
                                                                                                <h6>Edit Post</h6>
                                                                                                <p class="mb-0">
                                                                                    ...
                                                                                    <a class="dropdown-item p-3"
                                                                                     ...
                                                                                     {{-- <a class="dropdown-item p-3" href="{{ route('posts.destroy', $post->id) }}">
                                                        ...
                                                        <div class="user-post">
                                                            ...
                                                            <a href="#"><img src="../assets/images/page-img/p1.jpg"
                                                    ...
                                                    {{-- edit post modal --}}
                                                    <div class="modal fade" id="editPostModal{{ $post->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                ...
                                                <div class="post-item">
                                                    <div class="user-post-data py-3">
                                                        <div class="d-flex  justify-content-between">
                                                            ...
                                                            <div class="w-100">
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="">
                                                                        <h5 class="mb-0 d-inline-block me-1"><a href="#"
                                                                                class="">Bni Cyst</a></h5>
                                                    ...
                                                    <div class="user-post">
                                                        <a href="#"><img src="../assets/images/page-img/p3.jpg"
                                                                alt="post-image" class="img-fluid w-100" /></a>
                                                    </div>
                                                    <div class="comment-area mt-3">
                                                        <div
                                                ...
                                                <div class="post-item">
                                                    ...
                                                    <div class="user-post text-center">
                                                        <a href="#"><img src="../assets/images/page-img/p1.jpg"
                                                                alt="post-image" class="img-fluid profile-img" /></a>
                                                    </div>
                                                    <div class="comment-area mt-3">
                                                        <div
                                                            class="d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a class="nav-link" data-bs-toggle="pill" href="#pill-your-photos"
                                                data-bs-target="#your-photos">Your
                                                Photos</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                                            ...
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                                    <ul
                                                                        ...
                                                                        <li><a href="#" class="pe-3 text-white">
                                                                                60 <i class="ri-thumb-up-line"></i>
                                                                            </a></li>
                                                                        <li><a href="#" class="pe-3 text-white">
                                                                                30 <i class="ri-chat-3-line"></i>
                                                                            </a></li>
                                                                        <li><a href="#" class="pe-3 text-white">
                                                                                10 <i class="ri-share-forward-line"></i>
                                                                            </a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
